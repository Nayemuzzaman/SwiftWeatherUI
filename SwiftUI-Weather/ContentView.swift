...
//  SwiftUI-Weather
//
//  Created by Nayemuzzaman on 9/6/23.
//
    ...
    var body: some View {
        ZStack {
            ...
            VStack{
                ...
                WeatherShows(imageName: isNight ? "moon.stars.fill" : "cloud.sun.fill", temperature: 76)
                ...
                HStack(spacing: 20){
                    ...
                    WeatherDayView(dayOfWeek: "WED", imageName: "sun.max.fill", temperature: 89)
